...
MIGRATIONS: dict[int, list[str]] = {
    ...
    # v6：变动流水加 message（触发发言，仅 judge 路径记）与 reversed（该变动是否已被撤销）
    6: [
    ...
    # v9：favor 表加 points（P-C 印象带权点模型：[{point,weight,ts}] JSON 数组字符串）
    9: [
        "ALTER TABLE favor ADD COLUMN points TEXT NOT NULL DEFAULT '[]'",
    ],
}
