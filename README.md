...
- **主人身份**：按 QQ 号认定（昵称不可信），主人有专属身份标识与专属态度指引——数值照常涨跌，但低好感＝赌气别扭（不是对外人的疏离）、高好感＝亲昵依恋，每级主人语义可配（levels.*.master_guidance）
...
| levels.* | 见 schema | 七级阈值（含「厌恶」负值区间）与态度指引文本；每级另有 master_guidance（主人专属指引，低好感＝赌气别扭语义） |
